                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {filteredSources.map((source) => (
                            <div
                                key={source.id}
                                id={`source-${source.id}`}
                                className={`p-8 rounded-xl border-2 scroll-mt-24 transition-all duration-300 hover:shadow-lg hover:scale-102 bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 hover:border-blue-400 dark:hover:border-blue-500 ${flashingId === source.id ? 'flash-card' : ''}`}
                            >
